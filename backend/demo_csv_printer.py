"""
Demonstration of CSV Pretty Printer
"""
...
# Demo 1: Format customer records without probability
...
# Demo 2: Format customer records with probability
...
# Demo 3: Format predictions
print("3. Format predictions:")
print("-" * 80)
predictions = [
    {
        "input_features": customer_records[0],
        "probability": 0.234567
    },
    {
        "input_features": customer_records[1],
...
# Demo 4: Show numeric formatting
...
# Demo 5: Show RFC 4180 compliance (special characters)
print("5. RFC 4180 compliance (special characters):")
print("-" * 80)
special_records = [
    {
        "customerID": "TEST,001",  # Comma
        "gender": "Male",
        "tenure": 12,
        "Contract": "Month-to-month",
        "PaymentMethod": "Bank transfer (automatic)",  # Parentheses
        "MonthlyCharges": 50.00,
        "TotalCharges": 600.00,
        "Churn": "No"
    },
    {
        "customerID": 'TEST"002',  # Quote
        "gender": "Female",
        "tenure": 24,
        "Contract": "One year",
